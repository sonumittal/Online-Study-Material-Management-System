...
{
  echo "<script>alert('This Paper with your provided details is already available. Please first get deleted that exsting paper by Super Admin then upload again.')</script>";
}
else 
{
