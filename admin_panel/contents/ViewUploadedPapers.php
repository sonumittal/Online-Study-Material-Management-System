...
while($result=mysqli_fetch_array($row))
{
  ...
  echo "<tr><th scope='row'>$no</th>";
   ...
   echo "<td>".$result['7']."</td>";
   $file=$result['6'];
 echo "<td><a href='uploaded_files/papers/".$file."' target='blank'>".$file."</a></td>";       
 echo "<td><a href='./contents/delete_papers_material_notification_function.php?paper_delete_id=$id'>Delete</a></td>
   </tr>";
   $no=$no+1;
  }
?>
